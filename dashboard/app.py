...
with col_left:
    ...
    <div style='background:rgba(16,25,41,0.7); padding:24px; border-radius:16px; border:1px solid rgba(43,62,88,0.5); margin-bottom:24px; box-shadow:0 10px 30px rgba(0,0,0,0.3);'>
        <div style='display:flex; align-items:center; gap:16px; margin-bottom:24px;'>
            ...
            <div>
                <h3 style='margin:0; color:#fff; font-weight:700; font-size:1.2rem;'>JANE DOE</h3>
                <span style='color:#8ba0b8; font-size:13px;'>ID: 749032</span>
            </div>
        </div>
        <div style='display:flex; justify-content:space-between; margin-bottom:24px;'>
            <div>
                <span style='color:#8ba0b8; font-size:13px;'>Age</span><br>
                <h2 style='margin:0; color:var(--cyan); font-weight:400;'>42</h2>
            </div>
            <div>
                <span style='color:#8ba0b8; font-size:13px;'>Status</span><br>
                <h2 style='margin:0; color:#ff4b4b; font-weight:400;'>Critical</h2>
            </div>
        </div>
        <div style='border-top:1px solid rgba(255,255,255,0.1); padding-top:20px; color:#8ba0b8; font-size:13px; line-height:1.6;'>
            ...
            Chest X-ray designed for advanced medical image analysis. Priority queue assigned due to elevated distress metrics.
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col_right:
    ...
    <div style='background:rgba(16,25,41,0.7); padding:24px; border-radius:16px; border:1px solid rgba(43,62,88,0.5); margin-bottom:24px; box-shadow:0 10px 30px rgba(0,0,0,0.3);'>
        ...
        <div style='display:flex; justify-content:space-between; margin-bottom:10px;'><span style='color:#8ba0b8; font-size:13px;'>Scan Date</span><span style='color:#fff; font-size:13px;'>2024.10.26 14:32 PST</span></div>
        <div style='display:flex; justify-content:space-between; margin-bottom:10px;'><span style='color:#8ba0b8; font-size:13px;'>Scan Time</span><span style='color:#fff; font-size:13px;'>2024.10.26</span></div>
    ...
    action_btn = st.button("REVIEW SCAN", use_container_width=True)
    val_btn = st.button("VALIDATE FINDINGS", use_container_width=True)
